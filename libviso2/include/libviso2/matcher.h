...
public:
  ...
  void pushBack (const uint8_t *I1,const uint8_t* I2,int32_t* dims,const bool replace);
  ...
  void pushBack (const uint8_t *I1,int32_t* dims,const bool replace) { pushBack(I1,0,dims,replace); }
